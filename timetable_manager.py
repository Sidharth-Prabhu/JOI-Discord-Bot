        ...
        try:
            ...
            if starting_periods:
                ...
                if channel:
                    ...
                    cursor.execute(
                        "SELECT MIN(period_number) as first FROM timetable WHERE day_of_week = %s", (day_name,))
                    ...
                    cursor.execute(
                        "SELECT * FROM timetable WHERE day_of_week = %s AND period_number = %s", (day_name, p_num + 1))
            ...
            if ending_periods:
                cursor.execute(
                    "SELECT MAX(period_number) as last FROM timetable WHERE day_of_week = %s", (day_name,))
